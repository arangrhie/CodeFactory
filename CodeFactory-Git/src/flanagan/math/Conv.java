...
*
*   DATE:    April 2008
*   AMENDED: September 2009, 9-20 January 2011, 5 April 2012
*
*   DOCUMENTATION:
...
public class Conv{
   ...
   public static Double convert_double_to_Double(double x){
    ...
    public static String convert_Float_to_String(Float x){
        return Float.toString(x.floatValue());
    }
    ...
    public static String convert_Long_to_String(Long x){
        return Long.toString(x.longValue());
    }
    ...
    public static String convert_Integer_to_String(Integer x){
        return Integer.toString(x.intValue());
    }
    ...
    public static String convert_Short_to_String(Short x){
        return Short.toString(x.shortValue());
    }
    ...
    public static String convert_Byte_to_String(Byte x){
        return Byte.toString(x.byteValue());
    }
    ...
    public static BigDecimal convert_char_to_BigDecimal(char x){
        return new BigDecimal(Conv.convert_char_to_String(x));
    }
    
    public static BigDecimal convert_char_to_BigDecimal(Character x){
        return new BigDecimal(Conv.convert_Character_to_String(x));
    }
    
    public static BigInteger convert_char_to_BigInteger(char x){
        return new BigInteger(Conv.convert_char_to_String(x));
    }
    
    public static BigInteger convert_char_to_BigInteger(Character x){
        return new BigInteger(Conv.convert_Character_to_String(x));
    }
